...
class Context {
  listener: ((endpoint: string, req: object|undefined) => unknown) | undefined = undefined;
...
class Endpoint<Req = unknown, Res = unknown> {
  ...
  async request(req: Req): Promise<Res> {
    if (this.listener !== undefined) {
      ...
      return await this.ctx.listener(this.endpoint, req as object|undefined) as Res
    }
...
export const LocDel = new Endpoint<IDQuery, ServerSuccess>(Ctx, '/location/delete');
