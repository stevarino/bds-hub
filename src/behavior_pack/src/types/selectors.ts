...
export type SuperSelector = Partial<
  TagSelector & NameSelector & SelectorSelector & LoreSelector & ItemTypeSelector>;

export type SubSelector = TagSelector | NameSelector | SelectorSelector | LoreSelector | ItemTypeSelector;