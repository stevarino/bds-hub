...
const parseBuildFile = (input: any): BuildFile => {
    const __is = (input: any): input is BuildFile => {
        const $io0 = (input: any): boolean => undefined === input.packs || "object" === typeof input.packs && null !== input.packs && false === Array.isArray(input.packs) && $io1(input.packs);
        ...
        const $io2 = (input: any): boolean => Array.isArray(input.version) && (input.version.length === 3 && "number" === typeof input.version[0] && "number" === typeof input.version[1] && "number" === typeof input.version[2]) && "string" === typeof input.hash;
    ...
    if (false === __is(input))
        ((input: any, _path: string, _exceptionable: boolean = true): input is BuildFile => {
            ...
            const $ao0 = (input: any, _path: string, _exceptionable: boolean = true): boolean => undefined === input.packs || ("object" === typeof input.packs && null !== input.packs && false === Array.isArray(input.packs) || $guard(_exceptionable, {
                path: _path + ".packs",
                expected: "(__type | undefined)",
                value: input.packs
            })) && $ao1(input.packs, _path + ".packs", true && _exceptionable) || $guard(_exceptionable, {
                path: _path + ".packs",
                expected: "(__type | undefined)",
                value: input.packs
            });
            ...
            const $ao2 = (input: any, _path: string, _exceptionable: boolean = true): boolean => ((Array.isArray(input.version) || $guard(_exceptionable, {
                path: _path + ".version",
                expected: "Version",
                value: input.version
                ...
                expected: "Version",
                value: input.version
            })) && ("string" === typeof input.hash || $guard(_exceptionable, {
                path: _path + ".hash",
                expected: "string",
                value: input.hash
            }));
